...
class Money
  ...
  class Currency
    ...
    TABLE = {
      ...
      :nok => { :priority => 100, :iso_code => "NOK", :name => "Norwegian Krone",                           :symbol => "kr",            :subunit => "Øre",           :subunit_to_unit => 100,  :symbol_first => true, :html_entity => "kr",       :decimal_mark => ",", :thousands_separator => ".", :symbol_after => true, :space_after => true},
      ...
      :sek => { :priority => 100, :iso_code => "SEK", :name => "Swedish Krona",                             :symbol => "kr",            :subunit => "Öre",           :subunit_to_unit => 100,  :symbol_first => true, :html_entity => "",         :decimal_mark => ".", :thousands_separator => ",", :symbol_after => true, :space_after => true},
